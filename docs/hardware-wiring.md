...
| 5 | LM2596S #2 | 降压→5V，**专供外设轨** | 电池原始轨 | →PCA9685 V+/灯带/74AHCT125 | ✅ |
...
| 11 | **OV5640 (500万)** | **后置**摄像头(倒车/后视) | 后云台 | `/dev/video0`（USB/MIPI） | 🧪 |
...
[known-issues.md](known-issues.md) 维护。
